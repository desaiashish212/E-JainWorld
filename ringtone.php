			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"><?echo "Ringtone";?></h2>
							<a href="add_ringtone.php">  <button class="btn btn-primary" type="submit">Add Ringtone</button></a>
				...
				$stmt = $conn->prepare("SELECT ringtone.id,ringtone.mtitle,ringtone.url,ringtone.notify_status FROM ringtone");
       ...
       $stmt->store_result();
				...
				while($row = fetchAssocStatement($stmt))
				{
					...
					?>
						...
						<tr align="left">
						<td height="30"> <? echo $row['mtitle']; ?>


						</td>	<!-- Title containt-->
						
						<td width="50"><a href="ringtone.php?id=<?=$news_id;?>" class="btn btn-danger">Delete</a></td>
						<?
