			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<?
						$stmt = $conn->prepare("SELECT marathi_news.title,marathi_news.discription,marathi_news.url,marathi_news.date,marathi_news.repoter_id FROM  marathi_news WHERE marathi_news.id = ?");
        $stmt->bind_param("i", $_GET['id']);
        if ($stmt->execute()) {
            // $user = $stmt->get_result()->fetch_assoc();
            $stmt->bind_result($title, $discription, $url,$date,$repoter_id);
            $stmt->fetch();
        ...
        ?>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form class="form-horizontal" method="post" action="worker_edit_news.php" enctype="multipart/form-data" onSubmit="return validate(this)" >
									<div class="form-group">
										<label class="col-sm-2 control-label">Title</label>
										<div class="col-sm-10">
											
											<input type="text" placeholder="enter news title here" name="title" id="title" value="<?php echo $title;?>" class="form-control mb">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea class="form-control"  name="news" id="news" value="" rows="10"><?php echo $discription;?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<input type="text" placeholder="enter url here" name="url" id="url" value="<?php echo $url;?>" class="form-control mb">
