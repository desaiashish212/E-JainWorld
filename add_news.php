					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form method="POST" class="form-horizontal" method="post" action="creaate_news.php" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<input type="text" placeholder="enter url here" name="url" id="url" class="form-control mb" >
