			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Pravachan</h2>

						
						<div class="panel panel-default">
							<div class="panel-heading">Pravachan</div>
							<div class="panel-body">
								<form method="POST" class="form-horizontal" method="post" action="m_create_pravachan.php" enctype="multipart/form-data">
									...
									<div class="form-group">
										<div class="col-sm-8 col-sm-offset-2">
											<button class="btn btn-primary" type="submit" value="submit">Save pravachan</button>
										</div>
									</div>
								</form>
