			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title"><?echo "Repoters";?></h2>
							<a href="add_repoter.php">  <button class="btn btn-primary" type="submit">Add Repoter</button></a>
				...
				{ ?>
					...
					?>
						...
						<div class="panel panel-default">
							<div class="panel-heading">Repoters</div>
				...
				$stmt = $conn->prepare("SELECT repoters.id,repoters.username,repoters.oragnasation,repoters.date,repoters.`status` FROM repoters ORDER BY date desc");
       ...
       $stmt->store_result();
				...
				while($row = fetchAssocStatement($stmt))
				{
					...
					?>
						...
						<tr align="left"> 
						<td height="30" width="300"> <? echo $row['username']; ?></td>
						<td height="30" width="300"> <? echo $row['oragnasation']; ?></td>						<!-- Title containt-->
								<!-- news containt-->
						<td width="100"><? echo $row['username']; ?></td>				<!-- Time containt-->
						<td width="100"><? echo $row['date']; ?></td>				<!-- Time containt-->
						<td width="50"><a href="edit_repoter.php?id=<?=$repoter_id;?>" class="btn btn-primary">Edit</a></td>
						<td width="50"><a href="delete_repoter.php?id=<?=$repoter_id;?>" class="btn btn-danger">Delete</a></td>
						<?
							if($row['status']==0){
						?>
						<td><a href="worker_news_notifications.php?id=<?= $repoter_id ;?>" class="btn btn-info">Notify</a></td>
						<?
							}else{
						?>
