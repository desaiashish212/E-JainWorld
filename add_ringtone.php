	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class="open"><a href="ringtone.php"><i class="fa fa-dashboard"></i> Ringtone</a></li>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Ringtone</h2>


						<div class="panel panel-default">
							<div class="panel-heading">Ringtone</div>
							<div class="panel-body">
								<form method="POST" class="form-horizontal" method="post" action="create_ringtone.php" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-2 control-label">Title</label>
										<div class="col-sm-10">

											<input type="text" placeholder="enter marathi title here" name="mtitle" id="mtitle" class="form-control mb" required>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input id="input-43" type="file" name="files[]" multiple accept="audio/* required">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-8 col-sm-offset-2">
											<button class="btn btn-primary" type="submit" value="submit">Save ringtone</button>
										</div>
									</div>
								</form>
